 ...
 webViewHeight = Ti.Platform.displayCaps.platformHeight - $.web.top;
 ...
 if (OS_ANDROID) {
   ...
   function loadWebViewAndroid() {
     ...
     webViewHeight = Ti.Platform.displayCaps.platformHeight - ($.web.top * Ti.Platform.displayCaps.logicalDensityFactor);
